...
function PartnersSection() {
  return (
    <section className="relative pb-35 -mt-20">
      <div className="lg:h-53.5 h-20">
        <div className="bg-background/15 absolute top-0 bottom-0 z-10 my-auto h-fit w-[110%] rotate-[3.5deg] py-9 backdrop-blur-xl">
        ...
        <div className="bg-primary absolute top-0 bottom-0 my-auto h-fit w-[110%] rotate-[-3.5deg] py-9">
          <InfiniteMarquee images={logos} from={'-100%'} to={0} color="text-background" />
        </div>
      </div>
    </section>
  )
