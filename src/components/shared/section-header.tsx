  ...
  return (
    <div className="mx-auto flex max-w-4xl flex-col items-center gap-4">
      <h3 className="text-primary bg-primary/13 leading-custom-1 flex items-center gap-3 rounded-4xl px-3.25 py-2.5 text-sm font-medium md:text-base lg:text-lg">
        <Asterisks className="text-primary h-3.5 w-3.5 animate-spin lg:h-4.5 lg:w-4.5" />
        {subtitle}
      </h3>
      <h2 className="lg:text-custom-44 text-custom-32 text-center leading-[1] font-black text-balance uppercase">
        {title}
      </h2>
    </div>
  )
